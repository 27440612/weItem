    ...
    <div class="amend">
        ...
        <form class="restForm">
          ...
          <section class="input_container captcha_code_container">
            <input type="text" placeholder="验证码" name="mobileCode" maxlength="6" v-model.number="Verify">
            <div class="img_change_img">
              <img :src="yanUrl"> 
              <div class="change_img">
                <p class="kan">看不清</p> <p class="huan"@click="random">换一张</p>
              </div>
            </div>
          </section>
        </form>
...
<style scoped>
 ...
 .restForm .phone_number{
  ...
  .restForm .captcha_code_container .img_change_img .change_img .kan{
    font-size: .4rem;
    color: #666;
  }
